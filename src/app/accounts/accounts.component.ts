...
import { AsyncPipe, NgIf, NgFor, NgClass, DecimalPipe, DatePipe } from '@angular/common';

@Component({
  selector: 'app-accounts',
  standalone: true,
  imports: [ReactiveFormsModule, AsyncPipe, NgIf, NgFor, NgClass, DecimalPipe, DatePipe],
